...
dataset = image_dataset_from_directory('../dataset/face_img/thumbnails128x128',
...
def train(epochs: int):
    ...
    for epoch in range(epochs):
        ...
        # wgan_generator.save('models/face/GAN_face_gen_60.h5')
...
# n = 100
# images = wgan_generator.predict(tf.random.normal([n, hidden_dim]))
# for i in range(n):
#     plt.imshow(images[i])
#     plt.axis('off')
#     plt.show()
