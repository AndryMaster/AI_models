...
from keras.layers.merging import add as Merge
...
class RandomWeightedAverage(Merge):
    ...
    def __call__(self, inputs):  # _merge_function
...
class WGANGP():
    ...
    def _build_adversarial(self):
        ...
        # 'interpolated_img_samples' argument
        ...
        # For the wgan_generator we freeze the critic'y layers
    ...
    , using_generator = False):
        ...
        for epoch in range(self.epoch, self.epoch + epochs):
            ...
            #       (epochs, critic_loops, 1, d_loss[0], d_loss[1],d_loss[2],d_loss[3],g_loss))
    ...
    def plot_model(self, run_folder):
        plot_model(self.model, to_file=os.path.join(run_folder ,'viz/self_model.png'), show_shapes = True, show_layer_names = True)
        plot_model(self.critic, to_file=os.path.join(run_folder ,'viz/critic.png'), show_shapes = True, show_layer_names = True)
        plot_model(self.generator, to_file=os.path.join(run_folder ,'viz/wgan_generator.png'), show_shapes = True, show_layer_names = True)
    ...
    def save_model(self, run_folder):
        self.model.save(os.path.join(run_folder, 'self_model.h5'))
        self.critic.save(os.path.join(run_folder, 'critic.h5'))
        self.generator.save(os.path.join(run_folder, 'wgan_generator.h5'))
